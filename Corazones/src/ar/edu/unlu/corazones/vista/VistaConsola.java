...
public class VistaConsola implements IVista {
	...
	private void modificarJugador() {
		...
		System.out.print("Por favor, ingrese el nombre del nuevo jugador: ");
		String nombre = entrada.next();
	...
	public void pedirCarta() {
		...
		System.out.println("Es el turno del jugador: "
				+ this.controlador.jugadorActual().getNombre()); //Digo quien tiene que jugar
		continuar();
		combinacionRondaJugada();
		System.out.println("****************************");
		System.out.println("*    JUGADOR #" + this.controlador.jugadorActual().getNombre() + "    *");
